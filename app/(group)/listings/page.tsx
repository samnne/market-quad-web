...
const ListingPage = () => {
  ...
  const baseListings = searchQuery && searchResults !== null ? searchResults : listings;
        ...
        <div className="flex gap-1 bg-white border border-[#c8f5e8] rounded-xl p-1">
          ...
          >
            <svg width="13" height="13" viewBox="0 0 13 13" fill="none">
              <rect x="0" y="0" width="5.5" height="5.5" rx="1.5" fill={view === "grid" ? "#17f3b5" : "#6b9e8a"} />
              <rect x="7.5" y="0" width="5.5" height="5.5" rx="1.5" fill={view === "grid" ? "#17f3b5" : "#6b9e8a"} />
              <rect x="0" y="7.5" width="5.5" height="5.5" rx="1.5" fill={view === "grid" ? "#17f3b5" : "#6b9e8a"} />
              <rect x="7.5" y="7.5" width="5.5" height="5.5" rx="1.5" fill={view === "grid" ? "#17f3b5" : "#6b9e8a"} />
            </svg>
          </button>
          <button
          ...
          >
            <svg width="13" height="10" viewBox="0 0 13 10" fill="none">
              <path d="M4 1h9M4 5h9M4 9h9" stroke={view === "list" ? "#17f3b5" : "#6b9e8a"} strokeWidth="1.5" strokeLinecap="round" />
              <circle cx="1.5" cy="1" r="1" fill={view === "list" ? "#17f3b5" : "#6b9e8a"} />
              <circle cx="1.5" cy="5" r="1" fill={view === "list" ? "#17f3b5" : "#6b9e8a"} />
              <circle cx="1.5" cy="9" r="1" fill={view === "list" ? "#17f3b5" : "#6b9e8a"} />
            </svg>
          </button>
        </div>
      </div>
